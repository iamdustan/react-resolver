...
var Resolver = (function (_React$Component) {
  ...
  _createClass(Resolver, null, [{
    ...
    value: function value(render, node) {
      var initialData = window.__REACT_RESOLVER_PAYLOAD__;

      // Server-rendered output, but missing payload
      if (!initialData && node.innerHTML) {
        return Resolver.resolve(render).then(function (_ref) {
          var Resolved = _ref.Resolved;

          // @TODO - Use react-dom.render
          _react2["default"].render(_react2["default"].createElement(Resolved, null), node);
        });
      }
    ...
    value: function value(_render) {
      ...
      _react2["default"].renderToStaticMarkup(_react2["default"].createElement(
        Resolver,
  ...
  _createClass(Resolver, [{
    ...
    value: function resolve(state) {
      ...
      var promises = pending.map(function (_ref3) {
